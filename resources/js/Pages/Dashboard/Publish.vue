        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div class="mb-6">
            ...
            <div class="flex items-center space-x-4">
              <select 
                v-model="newAccountSelection"
                @change="addAccountToSelection"
          ...
          <div class="mb-6">
            ...
            <textarea
              v-model="postContent"
              placeholder="What's on your mind? Let the world know your story."
              rows="6"
            ...
            <!-- AI Content Wizard -->
            <div class="mt-3">
              <button class="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600 transition-colors flex items-center space-x-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center space-x-4">
              <button class="p-2 text-gray-500 hover:text-gray-700" title="Emoji">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8m2-10H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2z"/>
                </svg>
              </button>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 sticky top-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex space-x-2">
              <button 
                v-for="platform in ['facebook', 'instagram', 'twitter']" 
                :key="platform"
                :class="`p-2 rounded ${
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            <p class="text-sm text-yellow-800">
              Social media platforms often update their formatting, which may cause your posts to appear slightly different once published.
            </p>
          ...
          <!-- Action Buttons -->
          <div class="space-y-3">
            <button class="w-full bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center space-x-2">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
